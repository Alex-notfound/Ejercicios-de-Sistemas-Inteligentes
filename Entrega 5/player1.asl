...
colocarPerder(X,EquipoAliado,EquipoEnemigo):-
							 tablero(X,Y,0)[source(percept)] & not unoEnRaya(X,Y,EquipoAliado) & not bloquearCuatroEnRaya(BestX,EquipoAliado,EquipoEnemigo)
							|tablero(X,Y,0)[source(percept)] & not unoEnRaya(X,Y,EquipoAliado) & not bloquearTresEnRaya(BestX,EquipoAliado,EquipoEnemigo)
							
							|tablero(X,Y,0)[source(percept)] & not dosEnRaya(X,Y,EquipoAliado )& not bloquearCuatroEnRaya(BestX,EquipoAliado,EquipoEnemigo)
							|tablero(X,Y,0)[source(percept)] & not dosEnRaya(X,Y,EquipoAliado) & not bloquearTresEnRaya(BestX,EquipoAliado,EquipoEnemigo)
							
							|tablero(X,Y,0)[source(percept)] & not tresEnRaya(X,Y,EquipoAliado) & not bloquearCuatroEnRaya(BestX,EquipoAliado,EquipoEnemigo)
							|tablero(X,Y,0)[source(percept)] & not tresEnRaya(X,Y,EquipoAliado) & not bloquearTresEnRaya(BestX,EquipoAliado,EquipoEnemigo)

							|tablero(X,Y,0)[source(percept)] & not cuatroEnRaya(X,Y,EquipoAliado) & not bloquearCuatroEnRaya(BestX,EquipoAliado,EquipoEnemigo)
							|tablero(X,Y,0)[source(percept)] & not cuatroEnRaya(X,Y,EquipoAliado) & not bloquearTresEnRaya(BestX,EquipoAliado,EquipoEnemigo)
