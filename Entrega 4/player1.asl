...
raya([16,16,0,0],X,P) :- P=3 & X=2.
raya([0,16,16,0],X,P) :- P=3 & X=0.
raya([0,0,16,16],X,P) :- P=3 & X=1.
raya([0,16,0,16],X,P) :- P=3 & X=2.
...
raya([17,17,0,0],X,P) :- P=4 & X=2.
raya([0,17,17,0],X,P) :- P=4 & X=0.
raya([0,0,17,17],X,P) :- P=4 & X=1.
raya([0,17,0,17],X,P) :- P=4 & X=2.
